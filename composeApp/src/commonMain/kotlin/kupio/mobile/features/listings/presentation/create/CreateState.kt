...
data class CreateState(
    ...
    val categoriesError: CreateError? = null,
    val isLoadingSubcategories: Boolean = false,
    val subcategoriesError: CreateError? = null,
    ...
    val filtersError: CreateError? = null,
    val fieldErrors: Map<CreateField, CreateError> = emptyMap(),
    val filterErrors: Map<String, CreateError> = emptyMap(),
